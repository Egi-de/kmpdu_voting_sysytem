...
const initialUsers: SystemUser[] = [
  ...
  { id: '3', name: 'Peter Wanjala', memberId: 'KMPDU-2026-00003', nationalId: '24567890', phone: '+254 733 300 003', branch: 'Mombasa Branch', status: 'active', createdAt: '2026-01-12', lastLogin: null },
  { id: '4', name: 'Mary Atieno', memberId: 'KMPDU-2026-00004', nationalId: '25678901', phone: '+254 744 400 004', branch: 'Mombasa Branch', status: 'active', createdAt: '2026-01-13', lastLogin: null },
  { id: '5', name: 'Brian Kipkorir', memberId: 'KMPDU-2026-00005', nationalId: '26789012', phone: '+254 755 500 005', branch: 'Kisumu Branch', status: 'active', createdAt: '2026-01-14', lastLogin: null },
  { id: '6', name: 'Grace Mutua', memberId: 'KMPDU-2026-00006', nationalId: '27890123', phone: '+254 766 600 006', branch: 'Kisumu Branch', status: 'active', createdAt: '2026-01-15', lastLogin: null },
  { id: '7', name: 'David Mwangi', memberId: 'KMPDU-2026-00007', nationalId: '28901234', phone: '+254 777 700 007', branch: 'Nakuru Branch', status: 'active', createdAt: '2026-01-16', lastLogin: null },
  { id: '8', name: 'Alice Njoroge', memberId: 'KMPDU-2026-00008', nationalId: '29012345', phone: '+254 788 800 008', branch: 'Nakuru Branch', status: 'active', createdAt: '2026-01-17', lastLogin: null },
  { id: '9', name: 'John Otieno', memberId: 'KMPDU-2026-00009', nationalId: '30123456', phone: '+254 799 900 009', branch: 'Eldoret Branch', status: 'active', createdAt: '2026-01-18', lastLogin: null },
  { id: '10', name: 'Esther Chebet', memberId: 'KMPDU-2026-00010', nationalId: '31234567', phone: '+254 711 000 010', branch: 'Eldoret Branch', status: 'active', createdAt: '2026-01-19', lastLogin: null },
  { id: '11', name: 'Samuel Odhiambo', memberId: 'KMPDU-2026-00011', nationalId: '32345678', phone: '+254 722 100 011', branch: 'Nyeri Branch', status: 'active', createdAt: '2026-01-20', lastLogin: null },
  { id: '12', name: 'Faith Wambui', memberId: 'KMPDU-2026-00012', nationalId: '33456789', phone: '+254 733 200 012', branch: 'Nyeri Branch', status: 'active', createdAt: '2026-01-21', lastLogin: null },
  { id: '13', name: 'Joseph Musyoka', memberId: 'KMPDU-2026-00013', nationalId: '34567890', phone: '+254 744 300 013', branch: 'Machakos Branch', status: 'active', createdAt: '2026-01-22', lastLogin: null },
  { id: '14', name: 'Carol Kilonzo', memberId: 'KMPDU-2026-00014', nationalId: '35678901', phone: '+254 755 400 014', branch: 'Machakos Branch', status: 'active', createdAt: '2026-01-23', lastLogin: null },
  { id: '15', name: 'Daniel Mogaka', memberId: 'KMPDU-2026-00015', nationalId: '36789012', phone: '+254 766 500 015', branch: 'Kisii Branch', status: 'active', createdAt: '2026-01-24', lastLogin: null },
  { id: '16', name: 'Ruth Nyanchama', memberId: 'KMPDU-2026-00016', nationalId: '37890123', phone: '+254 777 600 016', branch: 'Kisii Branch', status: 'active', createdAt: '2026-01-25', lastLogin: null },
  { id: '17', name: 'Kelvin Juma', memberId: 'KMPDU-2026-00017', nationalId: '38901234', phone: '+254 788 700 017', branch: 'Nairobi Branch', status: 'active', createdAt: '2026-01-26', lastLogin: null },
  { id: '18', name: 'Mercy Koech', memberId: 'KMPDU-2026-00018', nationalId: '39012345', phone: '+254 799 800 018', branch: 'Eldoret Branch', status: 'active', createdAt: '2026-01-27', lastLogin: null },
  { id: '19', name: 'Paul Simiyu', memberId: 'KMPDU-2026-00019', nationalId: '40123456', phone: '+254 712 345 678', branch: 'Mombasa Branch', status: 'active', createdAt: '2026-01-28', lastLogin: null },
  { id: '20', name: 'Linda Achieng', memberId: 'KMPDU-2026-00020', nationalId: '41234567', phone: '+254 723 456 789', branch: 'Kisumu Branch', status: 'active', createdAt: '2026-01-29', lastLogin: null },
];
